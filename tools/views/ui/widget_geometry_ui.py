...
class Ui_widget_geometry(object):
    def setupUi(self, widget_geometry):
        ...
        widget_geometry.resize(321, 364)
        ...
        icon1 = QIcon()
        icon1.addFile(u"tools/icons/purple/undo.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u"tools/icons/purple/x-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(u"tools/icons/purple/undo.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon4.addFile(u"tools/icons/purple/undo.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon5 = QIcon()
        icon5.addFile(u"tools/icons/grey/box-select.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon5.addFile(u"tools/icons/blue/box-select.svg", QSize(), QIcon.Normal, QIcon.On)
        icon5.addFile(u"tools/icons/grey/box-select.svg", QSize(), QIcon.Disabled, QIcon.Off)
        icon5.addFile(u"tools/icons/grey/box-select.svg", QSize(), QIcon.Disabled, QIcon.On)
        ...
        icon6 = QIcon()
        icon6.addFile(u"tools/icons/grey/crop.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon6.addFile(u"tools/icons/blue/crop.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        sizePolicy2.setHeightForWidth(self.lineEdit_default_shot_crop_rectangle.sizePolicy().hasHeightForWidth())
        self.lineEdit_default_shot_crop_rectangle.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.pushButton_default_shot_discard.sizePolicy().hasHeightForWidth())
        self.pushButton_default_shot_discard.setSizePolicy(sizePolicy3)
        self.pushButton_default_shot_discard.setFocusPolicy(Qt.NoFocus)
        icon7 = QIcon()
        icon7.addFile(u"tools/icons/grey/undo.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon7.addFile(u"tools/icons/purple/undo.svg", QSize(), QIcon.Normal, QIcon.On)
        self.pushButton_default_shot_discard.setIcon(icon7)
        ...
        sizePolicy2.setHeightForWidth(self.lineEdit_shot_crop_rectangle.sizePolicy().hasHeightForWidth())
        self.lineEdit_shot_crop_rectangle.setSizePolicy(sizePolicy2)
        ...
        self.pushButton_shot_discard.setIcon(icon7)
