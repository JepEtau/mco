...
class Ui_widget_stitching(object):
    def setupUi(self, widget_stitching):
        ...
        widget_stitching.resize(332, 585)
        ...
        self.pushButton_set_preview = QPushButton(widget_stitching)
        ...
        self.pushButton_save_modifications = QPushButton(widget_stitching)
        ...
        self.pushButton_discard_modifications = QPushButton(widget_stitching)
        ...
        self.pushButton_close = QPushButton(widget_stitching)
        ...
        self.groupBox_stitching = QGroupBox(widget_stitching)
        ...
        sizePolicy.setHeightForWidth(self.radioButton_shot_homography.sizePolicy().hasHeightForWidth())
        self.radioButton_shot_homography.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_roi_edition.sizePolicy().hasHeightForWidth())
        self.pushButton_roi_edition.setSizePolicy(sizePolicy1)
        icon4 = QIcon()
        icon4.addFile(u"img/select-rectangular.png", QSize(), QIcon.Normal, QIcon.Off)
        icon4.addFile(u"img/select-rectangular.png", QSize(), QIcon.Normal, QIcon.On)
        icon4.addFile(u"img/select-rectangular_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
        ...
        sizePolicy.setHeightForWidth(self.pushButton_roi_discard_modifications.sizePolicy().hasHeightForWidth())
        self.pushButton_roi_discard_modifications.setSizePolicy(sizePolicy)
        self.pushButton_roi_discard_modifications.setIcon(icon2)
        ...
        sizePolicy.setHeightForWidth(self.doubleSpinBox_sharpen_amount.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_sharpen_amount.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.radioButton_sift.sizePolicy().hasHeightForWidth())
        self.radioButton_sift.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.radioButton_surf.sizePolicy().hasHeightForWidth())
        self.radioButton_surf.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.radioButton_brisk.sizePolicy().hasHeightForWidth())
        self.radioButton_brisk.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.radioButton_orb.sizePolicy().hasHeightForWidth())
        self.radioButton_orb.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.groupBox_match_descriptors.sizePolicy().hasHeightForWidth())
        self.groupBox_match_descriptors.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.doubleSpinBox_knn_ratio.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_knn_ratio.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.groupBox_find_homography.sizePolicy().hasHeightForWidth())
        self.groupBox_find_homography.setSizePolicy(sizePolicy1)
        ...
        sizePolicy.setHeightForWidth(self.doubleSpinBox_ransac_reproj_threshold.sizePolicy().hasHeightForWidth())
        self.doubleSpinBox_ransac_reproj_threshold.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.pushButton_crop_edition.sizePolicy().hasHeightForWidth())
        self.pushButton_crop_edition.setSizePolicy(sizePolicy1)
        icon5 = QIcon()
        ...
        self.pushButton_crop_edition.setIcon(icon5)
        ...
        sizePolicy.setHeightForWidth(self.pushButton_crop_reset_rectangle.sizePolicy().hasHeightForWidth())
        self.pushButton_crop_reset_rectangle.setSizePolicy(sizePolicy)
        self.pushButton_crop_reset_rectangle.setIcon(icon2)
        ...
        self.verticalLayout_3.addWidget(self.groupBox_stitching)
