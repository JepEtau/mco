...
class Ui_widget_geometry(object):
    def setupUi(self, widget_geometry):
        ...
        icon5 = QIcon()
        icon5.addFile(u"img/layer-visible-off.png", QSize(), QIcon.Normal, QIcon.Off)
        icon5.addFile(u"img/layer-visible-on.png", QSize(), QIcon.Normal, QIcon.On)
        self.pushButton_st_resize_preview.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u"img/gimp-tool-crop.png", QSize(), QIcon.Normal, QIcon.Off)
        icon6.addFile(u"img/gimp-tool-crop.png", QSize(), QIcon.Normal, QIcon.On)
        icon6.addFile(u"img/gimp-tool-crop_disabled.png", QSize(), QIcon.Disabled, QIcon.Off)
        self.pushButton_st_crop_edition.setIcon(icon6)
        ...
        self.pushButton_st_crop_preview.setIcon(icon5)
        ...
        self.pushButton_final_resize_preview.setIcon(icon5)
        ...
        self.pushButton_final_crop_preview.setIcon(icon5)
        ...
        icon7 = QIcon()
        icon7.addFile(u"img/edit-undo.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pushButton_final_crop_edition.setIcon(icon6)
