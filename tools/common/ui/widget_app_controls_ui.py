...
class Ui_widget_app_controls(object):
    def setupUi(self, widget_app_controls):
        ...
        icon = QIcon()
        icon.addFile(u"img/grey/save.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon.addFile(u"img/purple/save.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon1 = QIcon()
        icon1.addFile(u"img/grey/undo.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon1.addFile(u"img/purple/undo.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon2.addFile(u"img/purple/minus-square.svg", QSize(), QIcon.Normal, QIcon.On)
