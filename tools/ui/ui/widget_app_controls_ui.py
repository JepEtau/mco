...
class Ui_widget_app_controls(object):
    def setupUi(self, widget_app_controls):
        ...
        icon = QIcon()
        icon.addFile(u"tools/icons/grey/save.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon.addFile(u"tools/icons/purple/save.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon2 = QIcon()
        icon2.addFile(u"tools/icons/purple/minus-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u"tools/icons/purple/minus-square.svg", QSize(), QIcon.Normal, QIcon.On)
