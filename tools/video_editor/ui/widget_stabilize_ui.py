...
class Ui_widget_stabilize(object):
    def setupUi(self, widget_stabilize):
        ...
        icon1 = QIcon()
        icon1.addFile(u"icons/purple/refresh-cw.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon1.addFile(u"icons/purple/refresh-cw.svg", QSize(), QIcon.Normal, QIcon.On)
        icon1.addFile(u"icons/grey/refresh-cw.svg", QSize(), QIcon.Disabled, QIcon.Off)
        icon1.addFile(u"icons/grey/refresh-cw.svg", QSize(), QIcon.Disabled, QIcon.On)
        ...
        icon2 = QIcon()
        icon2.addFile(u"icons/grey/frame.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon2.addFile(u"icons/blue/frame.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon4 = QIcon()
        icon4.addFile(u"icons/purple/save.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon5 = QIcon()
        icon5.addFile(u"icons/grey/x-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon5.addFile(u"icons/purple/x-square.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon6 = QIcon()
        icon6.addFile(u"icons/blue/log-out.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon6.addFile(u"icons/blue/log-out.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon7 = QIcon()
        icon7.addFile(u"icons/blue/arrow-left-right.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon7.addFile(u"icons/blue/arrow-left-right.svg", QSize(), QIcon.Normal, QIcon.On)
        icon7.addFile(u"icons/grey/arrow-left-right.svg", QSize(), QIcon.Disabled, QIcon.Off)
        icon7.addFile(u"icons/grey/arrow-left-right.svg", QSize(), QIcon.Disabled, QIcon.On)
        ...
        icon8 = QIcon()
        icon8.addFile(u"icons/blue/log-in.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon8.addFile(u"icons/blue/log-in.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon9 = QIcon()
        icon9.addFile(u"icons/purple/undo.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u"icons/blue/arrow-big-down.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon10.addFile(u"icons/blue/arrow-big-down.svg", QSize(), QIcon.Normal, QIcon.On)
        icon10.addFile(u"icons/grey/arrow-big-down.svg", QSize(), QIcon.Disabled, QIcon.Off)
        icon10.addFile(u"icons/grey/arrow-big-down.svg", QSize(), QIcon.Disabled, QIcon.On)
