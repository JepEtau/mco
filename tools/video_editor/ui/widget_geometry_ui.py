...
class Ui_widget_geometry(object):
    def setupUi(self, widget_geometry):
        ...
        widget_geometry.resize(411, 284)
        ...
        self.groupBox_custom_geometry = QGroupBox(self.frame)
        self.groupBox_custom_geometry.setObjectName(u"groupBox_custom_geometry")
        sizePolicy2.setHeightForWidth(self.groupBox_custom_geometry.sizePolicy().hasHeightForWidth())
        self.groupBox_custom_geometry.setSizePolicy(sizePolicy2)
        self.groupBox_custom_geometry.setCheckable(False)
        self.groupBox_custom_geometry.setChecked(False)
        self.gridLayout_2 = QGridLayout(self.groupBox_custom_geometry)
        self.gridLayout_2.setObjectName(u"gridLayout_2")
        self.gridLayout_2.setContentsMargins(3, 5, 3, 3)
        self.horizontalLayout_6 = QHBoxLayout()
        self.horizontalLayout_6.setObjectName(u"horizontalLayout_6")
        self.label_17 = QLabel(self.groupBox_custom_geometry)
        self.label_17.setObjectName(u"label_17")
        self.label_17.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_6.addWidget(self.label_17)

        self.spinBox_custom_width = QSpinBox(self.groupBox_custom_geometry)
        self.spinBox_custom_width.setObjectName(u"spinBox_custom_width")
        self.spinBox_custom_width.setEnabled(False)
        sizePolicy3.setHeightForWidth(self.spinBox_custom_width.sizePolicy().hasHeightForWidth())
        self.spinBox_custom_width.setSizePolicy(sizePolicy3)
        self.spinBox_custom_width.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.spinBox_custom_width.setMinimum(0)
        self.spinBox_custom_width.setMaximum(1920)
        self.spinBox_custom_width.setSingleStep(1)
        self.spinBox_custom_width.setValue(0)

        self.horizontalLayout_6.addWidget(self.spinBox_custom_width)

        self.label_18 = QLabel(self.groupBox_custom_geometry)
        self.label_18.setObjectName(u"label_18")
        self.label_18.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)

        self.horizontalLayout_6.addWidget(self.label_18)

        self.spinBox_custom_height = QSpinBox(self.groupBox_custom_geometry)
        self.spinBox_custom_height.setObjectName(u"spinBox_custom_height")
        self.spinBox_custom_height.setEnabled(False)
        sizePolicy3.setHeightForWidth(self.spinBox_custom_height.sizePolicy().hasHeightForWidth())
        self.spinBox_custom_height.setSizePolicy(sizePolicy3)
        self.spinBox_custom_height.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.spinBox_custom_height.setMinimum(0)
        self.spinBox_custom_height.setMaximum(1152)
        self.spinBox_custom_height.setSingleStep(1)
        self.spinBox_custom_height.setValue(0)

        self.horizontalLayout_6.addWidget(self.spinBox_custom_height)


        self.gridLayout_2.addLayout(self.horizontalLayout_6, 2, 3, 1, 1)

        self.pushButton_custom_crop_edition = QPushButton(self.groupBox_custom_geometry)
        self.pushButton_custom_crop_edition.setObjectName(u"pushButton_custom_crop_edition")
        self.pushButton_custom_crop_edition.setIcon(icon4)
        self.pushButton_custom_crop_edition.setCheckable(True)
        self.pushButton_custom_crop_edition.setAutoDefault(False)
        self.pushButton_custom_crop_edition.setFlat(True)

        self.gridLayout_2.addWidget(self.pushButton_custom_crop_edition, 0, 1, 1, 1)

        self.label_19 = QLabel(self.groupBox_custom_geometry)
        self.label_19.setObjectName(u"label_19")
        self.label_19.setLineWidth(0)

        self.gridLayout_2.addWidget(self.label_19, 1, 0, 1, 1)

        self.pushButton_custom_resize_preview = QPushButton(self.groupBox_custom_geometry)
        self.pushButton_custom_resize_preview.setObjectName(u"pushButton_custom_resize_preview")
        self.pushButton_custom_resize_preview.setIcon(icon)
        self.pushButton_custom_resize_preview.setCheckable(True)
        self.pushButton_custom_resize_preview.setFlat(True)

        self.gridLayout_2.addWidget(self.pushButton_custom_resize_preview, 1, 2, 1, 1)

        self.pushButton_custom_discard = QPushButton(self.groupBox_custom_geometry)
        self.pushButton_custom_discard.setObjectName(u"pushButton_custom_discard")
        sizePolicy4.setHeightForWidth(self.pushButton_custom_discard.sizePolicy().hasHeightForWidth())
        self.pushButton_custom_discard.setSizePolicy(sizePolicy4)
        self.pushButton_custom_discard.setIcon(icon2)
        self.pushButton_custom_discard.setFlat(True)

        self.gridLayout_2.addWidget(self.pushButton_custom_discard, 0, 4, 1, 1)

        self.checkBox_custom_keep_ratio = QCheckBox(self.groupBox_custom_geometry)
        self.checkBox_custom_keep_ratio.setObjectName(u"checkBox_custom_keep_ratio")
        self.checkBox_custom_keep_ratio.setEnabled(False)
        self.checkBox_custom_keep_ratio.setChecked(True)

        self.gridLayout_2.addWidget(self.checkBox_custom_keep_ratio, 1, 3, 1, 1)

        self.pushButton_custom_resize_edition = QPushButton(self.groupBox_custom_geometry)
        self.pushButton_custom_resize_edition.setObjectName(u"pushButton_custom_resize_edition")
        self.pushButton_custom_resize_edition.setEnabled(False)
        self.pushButton_custom_resize_edition.setIcon(icon5)
        self.pushButton_custom_resize_edition.setCheckable(True)
        self.pushButton_custom_resize_edition.setAutoDefault(False)
        self.pushButton_custom_resize_edition.setFlat(True)

        self.gridLayout_2.addWidget(self.pushButton_custom_resize_edition, 1, 1, 1, 1)

        self.pushButton_custom_crop_preview = QPushButton(self.groupBox_custom_geometry)
        self.pushButton_custom_crop_preview.setObjectName(u"pushButton_custom_crop_preview")
        self.pushButton_custom_crop_preview.setIcon(icon)
        self.pushButton_custom_crop_preview.setCheckable(True)
        self.pushButton_custom_crop_preview.setFlat(True)

        self.gridLayout_2.addWidget(self.pushButton_custom_crop_preview, 0, 2, 1, 1)

        self.label_10 = QLabel(self.groupBox_custom_geometry)
        self.label_10.setObjectName(u"label_10")
        self.label_10.setLineWidth(0)

        self.gridLayout_2.addWidget(self.label_10, 0, 0, 1, 1)

        self.lineEdit_custom_crop_rectangle = QLineEdit(self.groupBox_custom_geometry)
        self.lineEdit_custom_crop_rectangle.setObjectName(u"lineEdit_custom_crop_rectangle")
        sizePolicy5.setHeightForWidth(self.lineEdit_custom_crop_rectangle.sizePolicy().hasHeightForWidth())
        self.lineEdit_custom_crop_rectangle.setSizePolicy(sizePolicy5)
        self.lineEdit_custom_crop_rectangle.setMinimumSize(QSize(190, 0))
        self.lineEdit_custom_crop_rectangle.setMaximumSize(QSize(190, 16777215))
        self.lineEdit_custom_crop_rectangle.setFrame(False)
        self.lineEdit_custom_crop_rectangle.setAlignment(Qt.AlignCenter)
        self.lineEdit_custom_crop_rectangle.setReadOnly(True)

        self.gridLayout_2.addWidget(self.lineEdit_custom_crop_rectangle, 0, 3, 1, 1)


        self.verticalLayout_2.addWidget(self.groupBox_custom_geometry)
    ...
    def retranslateUi(self, widget_geometry):
        ...
        self.groupBox_custom_geometry.setTitle(QCoreApplication.translate("widget_geometry", u"Custom", None))
        ...
        self.pushButton_custom_crop_edition.setText("")
        self.label_19.setText(QCoreApplication.translate("widget_geometry", u"resize", None))
        self.pushButton_custom_resize_preview.setText("")
        self.pushButton_custom_discard.setText("")
        self.checkBox_custom_keep_ratio.setText(QCoreApplication.translate("widget_geometry", u"keep ratio", None))
        self.pushButton_custom_resize_edition.setText("")
        self.pushButton_custom_crop_preview.setText("")
        self.label_10.setText(QCoreApplication.translate("widget_geometry", u"crop", None))
        self.lineEdit_custom_crop_rectangle.setText(QCoreApplication.translate("widget_geometry", u"x:10, y:10, w:5000, h:5000", None))
        pass
    # retranslateUi
