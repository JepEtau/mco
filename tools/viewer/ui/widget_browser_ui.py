...
class Ui_widget_browser(object):
    def setupUi(self, widget_browser):
        ...
        icon = QIcon()
        icon.addFile(u"img/purple/minus-square.svg", QSize(), QIcon.Normal, QIcon.Off)
        icon.addFile(u"img/purple/minus-square.svg", QSize(), QIcon.Normal, QIcon.On)
        ...
        icon1.addFile(u"img/purple/x-square.svg", QSize(), QIcon.Normal, QIcon.On)
