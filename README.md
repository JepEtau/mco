...
- [nnedi3_weights.bin](https://github.com/dubhater/vapoursynth-nnedi3/blob/master/src/) à copier dans le répertoire `third_party`: https://github.com/dubhater/vapoursynth-nnedi3/tree/master/src
...
- Edition 's': [inputs/s](./inputs/s/README.md) (ep 11, 12)
- Edition 's0': [inputs/s0](./inputs/s0/README.md)
