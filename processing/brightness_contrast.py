...
def convert_scale(img: np.ndarray, alpha: float, beta: float):
...
def automatic_brightness_and_contrast_gray(
    gray_img: np.ndarray,
    clip_hist_percent: int = 25
):
    ...
    plt.show()
    '''
    auto_result = convert_scale(gray_img, alpha=alpha, beta=beta)
