...
options:
  ...
  --shot_max SHOT_MAX   debug: plans à générer: fin. NON VERIFIE
...
```
└── inputs
    ├── f  : répertoire contenant les vidéos de l'edition 'f'
    ...
    └── b  : répertoire contenant l'audio ou la vidéo de l'edition 'b'
```
...
├── cache
│   ├── ep01
│   │   ├── audio         : fichiers audio pour l'épisode (extrait, finalisé)
│   │   ├── concatenation : fichiers pour la concaténation des images/video
│   │   ├── video         : fichiers video
│   │   ├── ...
│   │   ├── ep01_av.mkv   : concatenation des fichiers audio/video
