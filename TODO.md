...
(1)
- try TTA
- simplify filters for video edition: remove deshake, replace, rgb, geometry
...
- clean filters.py
- replace 'end' by 'count'. Reason: end is not the real end but the frame_no of following shot. It was easier to debug ini files.
...
- when saving, use middle of shot or shot_no? Reason: if erroneous frame start no.
