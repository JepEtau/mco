...
def avisynth_deinterlace(shot, image_list,
    ...
    (filter_str, lines) = avisynth_patch_deinterlace_script(shot, script_filepath)
...
def avisynth_patch_deinterlace_script(shot:Shot, script_filepath):
...
def avisynth_script_executor(shot, image_list,
    ...
    # Parse and modify this script
    (filter_str, lines) = avisynth_patch_script(shot, script_filepath, input_filepath='')
    hash = calculate_hash(filter_str=filter_str)
